package com.niit.collabMiddleware.util;
...
public class FileUtil {
	...
	public static boolean uploadFile(HttpServletRequest request, MultipartFile file, String code)
	{
		...
		REAL_PATH=request.getSession().getServletContext().getRealPath("/assets/images/UserProfilePic/");
		...
		try
		{
			// transfer the file to oth location
