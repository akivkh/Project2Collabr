...
import com.niit.collabBackend.DaoImpl.ProfilePictureDaoImpl;
...
import com.niit.collabBackend.model.Message;
	...
	/// Data Source object
		...
		public SessionFactory getsessionFactory() {
			...
			System.out.println("hibernate properties object created.........!");
				   ...
				   // hibernateProp.put("hibernate.hbm2ddl.auto", "update"); // we can use create ,update ,create drop as value here.
					...
					builder.addAnnotatedClass(ForumComment.class);*/
